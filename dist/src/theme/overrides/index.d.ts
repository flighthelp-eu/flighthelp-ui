...
declare const _default: (theme: Theme) => {
    ...
    MuiIconButton: {
        ...
        styleOverrides?: Partial<import('@mui/material/styles/overrides').OverridesStyleRules<keyof import('@mui/material').IconButtonClasses, "MuiIconButton", unknown>> | undefined;
        variants?: {
